        ...
        <div class="booking-card">
            <div class="booking-card-top">
                <div class="pro-avatar" style="width:48px;height:48px;font-size:.9rem;margin:0">
                    {{ strtoupper(substr($b->professional->first_name,0,1).substr($b->professional->last_name,0,1)) }}
                </div>
                <div>
                    <div style="font-weight:700;font-family:'Syne',sans-serif">
                        {{ $b->professional->first_name }} {{ $b->professional->last_name }}
                    </div>
                    <div style="font-size:.85rem;color:var(--gray-mid)">{{ $b->professional->specialty }}</div>
                </div>

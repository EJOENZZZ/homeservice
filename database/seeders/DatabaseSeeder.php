    ...
    public function run(): void
    {
        $pros = [
            [
                'first_name'  => 'Grace',
                'last_name'   => 'Dela Cruz',
                'email'       => 'grace.delacruz@homefix.app',
            ...
            [
                'first_name'  => 'Luis',
                'last_name'   => 'Bautista',
                'email'       => 'luis.bautista@homefix.app',
                'password'    => Hash::make('Admin@12345'),
                'specialty'   => 'Cleaning',
                'badge'       => 'TOP PRO',
                'rating'      => 4.95,
            ...
            [
                'first_name'  => 'Maria',
                'last_name'   => 'Fernandez',
                'email'       => 'maria.fernandez@homefix.app',
                'password'    => Hash::make('Admin@12345'),
                'specialty'   => 'Painting',
                'badge'       => 'ELITE',
                'rating'      => 4.99,
